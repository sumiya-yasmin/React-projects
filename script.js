...
const projects = [
  ...
  projects.forEach(project => {
    ...
    projectLink.innerHTML = `<strong>Live Demo:</strong> <a href="https://sumiya-yasmin.github.io/React-projects/${project.name.replace(/ /g, '-')}/" target="_blank">View ${project.name}</a>`;
